            ...
            <form id="formReg" action="Registration.php" method="POST">
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="FirstNameReg" name="FirstNameReg"
                            placeholder="Enter Firstname" required>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label>Lastname</label>
                        <input type="text" class="form-control" id="LastNameReg" name="LastNameReg"
                ...
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        <label>Course</label>
                        <input type="text" class="form-control" id="CourseReg" name="CourseReg"
                    ...
                    <div class="col-md-3 mb-3">
                        <label>Age</label>
                        <input type="text" class="form-control" id="AgeReg" name="AgeReg" placeholder="Enter Age"
                            required>
                    </div>
                </div>
                <div class="form-row">
                ...
                <button class="btn btn-dark rounded-pill" type="submit" id="submitReg" data-toggle="modal" data-target="#exampleModal">Register!</button>
            </form>
        </div>
